-- Discovery feed: random profiles the viewer has not yet interacted with (for home swipe deck).
...
comment on function public.get_discovery_profiles(int) is
  'Random profiles excluding self and anyone already in profile_interactions for this viewer.';

grant execute on function public.get_discovery_profiles(int) to authenticated;
