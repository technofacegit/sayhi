-- Safer join RPC: validates BOTH selected zone_id and scanned/manual qr code.
...
begin
  ...
  insert into public.zone_members (
    zone_id, user_id, is_active, joined_at, updated_at
  )
  values (
    v_zone_id, v_user_id, true, now(), now()
  )
